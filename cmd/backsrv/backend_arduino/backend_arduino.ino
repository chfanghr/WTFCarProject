...
const int CommandGpio = 0, CommandIr = 1, CommandSerial = 2, CommandSerialHost = 3, CommandData = 4;
const int GpioPinmode = 0, GpioDigitalwrite = 1, GpioDigitalread = 2, GpioAnalogwrite = 3, GpioAnalogread = 4;
